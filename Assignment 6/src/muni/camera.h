...
struct Camera
{
    ...
    void init()
    {
        Vec3f middle_of_image_plane = position + focal_distance * view_direction;
        float theta = vertical_field_of_view * M_PI / 180.0f;
        float image_plane_height = 2.0f * focal_distance * std::tan(0.5f * theta);
        ...
        bottom_left_corner = middle_of_image_plane - 0.5f * right_vector - 0.5f * up_vector;
    }
    ...
    */
    ...
    {
        Vec3f position_on_image_plane = bottom_left_corner + u * right_vector + v * up_vector;
